...
class StableDiffusionInpaintPipeline(DiffusionPipeline, LoraLoaderMixin):
    r"""
    ...
    def __init__(
        self,
        # todo vae 还有个AsymmetricAutoencoderKL 看主仓是否上了
    ...
    def __call__(
        ...
        **kwargs,
        ...
        ...     "runwayml/stable-diffusion-inpainting", mindspore_dtype=mindspore.float16
        ... )
        ...
        if not output_type == "latent":
            ...
            image = self.vae.decode(
                latents / self.vae.config.scaling_factor, return_dict=False, **condition_kwargs
            )[0]
