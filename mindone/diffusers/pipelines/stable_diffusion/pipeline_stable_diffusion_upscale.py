...
from mindone.transformers import CLIPTextModel, CLIPTokenizer
...
class StableDiffusionUpscalePipeline(
    ...
    def __call__(
        ...
        ...     model_id, revision="fp16", torch_dtype=ms.float16
        ... )
        ...
        noise_level = ms.Tensor([noise_level], dtype=ms.float32)
